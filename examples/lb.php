...
try {
  ...
  foreach ($group_h as $item) {
    $group_lb[] = (lb::run($p, $item->nItem, $item));
  }

  echo '<p class="display-5">Grupo LB</p><p class="h5">Detalhamento Específico para Operação com Papel Imune</p><pre>';
  print_r($group_lb);
  echo '</pre>';
} catch (Exception $e) {
