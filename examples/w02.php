...
try {
  ...
  if (is_null($group_w02)) die('Nota Fiscal Inválida');

  echo '<p class="display-5">Grupo W02</p><p class="h5">Total da NF-e / Retenção de Tributos</p><pre>';
  print_r($group_w02);
  echo '</pre>';
} catch (Exception $e) {
