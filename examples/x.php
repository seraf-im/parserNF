...
try {
  ...
  if (is_null($group_x)) die('Nota Fiscal Inválida');

  echo '<p class="display-5">Grupo X</p><p class="h5">Informações do Transporte da NF-e</p><pre>';
  print_r($group_x);
  echo '</pre>';
} catch (Exception $e) {
