...
try {
  ...
  foreach ($group_h as $item) {
    $group_la[] = (la::run($p, $item->nItem, $item));
  }

  echo '<p class="display-5">Grupo LA</p><p class="h5">Detalhamento Específico de Combustíveis</p><pre>';
  print_r($group_la);
  echo '</pre>';
} catch (Exception $e) {
