...
try {
  ...
  if (is_null($group_za)) die('Nota Fiscal Inválida');

  echo '<p class="display-5">Grupo ZA</p><p class="h5">Informações de Comércio Exterior</p><pre>';
  print_r($group_za);
  echo '</pre>';
} catch (Exception $e) {
